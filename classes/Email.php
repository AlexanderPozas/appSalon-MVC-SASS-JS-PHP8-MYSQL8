...
class Email
{
    ...
    public function enviarConfirmacion()
    {
        ...
        $contenido .= "<p>Presiona Aquí: </p><a href='http://127.0.0.1:3000/confirmar-cuenta?token=" .$this->token. "'>Confirmar Cuenta</a>";
    ...
    public function enviarInstrucciones(){
        ...
        $contenido .= "<p>Presiona Aquí: </p><a href='http://17.0.0.1:3000/recover?token=" .$this->token. "'>Reestablecer Password</a>";
        $contenido .= "<img display:block; height=\"100px\" width=\"100px\" src='". $imgLocation ."'>";
